...
description: "Configure trusted publishing and publish the gsd-loop npm package from main."
---

This guide is for maintainers of `@opengsd/gsd-loop`. To update your installed
skills, see [troubleshooting](/loop/troubleshooting).
